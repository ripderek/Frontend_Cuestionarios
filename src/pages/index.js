...
import { Register } from "@/components/UsersControl";
  ...
  const IncioSesion = async (e) => {
    ...
    try {
      ...
      if (data1) {
        ...
        cookies.set("transparentnavbar", data1.transparentnavbar, {
          path: "/",
        });
      }
    ...
    <div className=" w-full h-full bg-gray-100">
      ...
      <div className="flex justify-between -p-10 ">
        <div className="mx-auto -p-5  hidden md:block">
          ...
          <div className=" mx-auto items-center text-center mt-2">
            <Lottie
              animationData={anim2}
              className="h-96 mx-auto items-center text-center "
            />
          </div>
        </div>
        <div className=" p-16 ">
          <Card
            color="transparent"
            shadow={false}
            className="w-full  shadow-xl p-6 rounded-none  border-solid text-center bg-white items-center justify-center shadow-blue-gray-200"
          >
            ...
            {autenticado ? (
              ...
              <form className="mt-8 mb-2" onSubmit={IncioSesion}>
                ...
                <Button
                  className="mt-6 bg-light-green-900 font-bold rounded-none hover:bg-orange-600"
                  type="submit"
                  fullWidth
                >
                  Aceptar
                ...
                >
                  ...
                  <div className="ml-2 font-bold ">Continuar con Google</div>
                </div>
                <Typography
                  color="gray"
