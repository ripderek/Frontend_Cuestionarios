...
export  function OPCLAV2({
  ...
  const Crear_pregunta = async () => {
    ...
    try {
      ...
      //p_clave2
      form.set("p_clave2", segundaClave);
      ...
      const result = await axios.post(
        process.env.NEXT_PUBLIC_ACCESLINK +
          "preguntas/Crear_pregunta_clave_valor_noJSON2",
        form,
        {
      ...
      AbrirEditor("OPCLAV2", id_nivel, true);
    } catch (error) {
      alert("Error");
      console.log(error);
      setLoader(false);
        ...
        <div className="mb-1 flex items-center justify-between gap-8">
          <div>
            <Typography variant="h4" color="orange">
              Pregunta con ingreso de datos 2
            </Typography>
          </div>
