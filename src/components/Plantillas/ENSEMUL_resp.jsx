...
import { ENSEMUL_edit, ENSEMUL_edit_resp } from "@/components/Plantillas";
export  function ENSEMUL_resp({
  id_pregunta,
  buscar,
  id_nivel,
  AbrirPreguntas,
  ...
  return (
    <Card className="w-auto mx-auto rounded-none">
      {editarPregunta && (
        <ENSEMUL_edit idpregunta={idPreguntaEdit} cerrar={CerrarEdit} />
      )}
      {editRespuesta && (
        <ENSEMUL_edit_resp
